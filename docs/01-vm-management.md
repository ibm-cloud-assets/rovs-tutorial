...
Before you run through this script, the advice is to scroll through the deep dive presentations and recordings you can find in this github: (#LMA)
...
1. Lets explore this page for a few moments: notice that this view is divided into 3 columns, the left-side management menu, the central column for organization of VM-based projects, and then the virtual machine view.
...
1. In the Name field, type vmexamples-user1 to name the project, then click Create.
