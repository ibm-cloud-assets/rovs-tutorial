...
## Tutorial 2 – Migrate Existing Virtual Machines to OpenShift Virtualization

Discover how to migrate virtual machines from VMware or other virtualization platforms into OpenShift Virtualization using Migration Toolkit for Virtualization (MTV). You'll learn how to assess, migrate, and validate workloads while minimizing disruption and accelerating modernization efforts.
